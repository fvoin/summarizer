...
_STRINGS: Dict[str, Dict[str, str]] = {
    ...
    "history_col_title":        {"en": "Meeting",                            "ru": "Встреча"},
    ...
    "lite_manual_recording": {"en": "Recording", "ru": "Запись"},
    ...
    "lite_setup_mic_title": {"en": "Microphone", "ru": "Микрофон"},
    "lite_setup_backend_title": {"en": "Backend connection", "ru": "Подключение к серверу"},
    "lite_setup_backend_text": {"en": "Where finished transcripts are uploaded. You can change this later in Settings.",
                                "ru": "Куда загружаются готовые расшифровки. Можно изменить позже в настройках."},
    "lite_setup_model_title": {"en": "Better transcription quality", "ru": "Лучшее качество расшифровки"},
    "lite_setup_model_text": {"en": "The app ships with the compact “base” model. The “medium” model (~1.5 GB) transcribes noticeably better, especially non-English speech. Download it now and it becomes the default.",
                              "ru": "В приложении установлена компактная модель «base». Модель «medium» (~1,5 ГБ) расшифровывает заметно точнее, особенно русскую речь. Скачайте её сейчас — она станет моделью по умолчанию."},
    "lite_setup_model_download": {"en": "Download medium", "ru": "Скачать medium"},
    "lite_setup_model_skip": {"en": "Skip — keep base", "ru": "Пропустить — оставить base"},
